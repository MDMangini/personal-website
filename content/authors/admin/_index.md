...
role: Assistant Professor of Political Science and International Relations at the University of Southern California
bio: My research focuses on economic coercion and the political economy of international trade.
social:
  - icon: envelope
    icon_pack: fas
    link: mailto:mmangini@usc.edu
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=6jQaxrkAAAAJ&hl=en
  - icon: clock
    icon_pack: fas
    link: https://calendly.com/mmangini-usc/
organizations:
